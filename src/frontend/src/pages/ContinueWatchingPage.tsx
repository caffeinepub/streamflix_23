...
export default function ContinueWatchingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0B] pt-24 pb-16 px-6 md:px-14">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          {history.length > 0 && (
            <button
              type="button"
              data-ocid="continue_watching.delete_button"
        ...
        {history.length === 0 && (
          <div
            data-ocid="continue_watching.empty_state"
          ...
          >
            ...
            <button
              type="button"
              data-ocid="continue_watching.primary_button"
              onClick={() => navigate({ to: "/" })}
